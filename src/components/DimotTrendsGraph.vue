<template>
  <div class="app-trend-graph">
    <div class="trend-body" v-if="$store.getters.shrink === false">
      <div class="trend-header">
        <div class="trend-header-right">
          ...
          <app-loader
            v-if="smallChangeLoading"
            class="small-change-loader"
          ></app-loader>
        </div>
            ...
            >
              ...
              <la-tooltip>
                <div class="tooltip" slot-scope="props">
                  ...
                  <ul class="list">
                    <li
                      v-for="(item, index) in props.actived"
